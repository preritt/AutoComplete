...
class args:
	data_file = '/u/scratch/p/pterway/UCLAProjects/ulzeeAutocomplete/AutoComplete/datasets/transformerIncorrectWithMask/ptest.csv'
	simulated_data_file = 'datasets/phenotypes/data_test.csv'
	imputed_data_file = '/u/scratch/p/pterway/UCLAProjects/ulzeeAutocomplete/AutoComplete/datasets/transformerIncorrectWithMask/data_fit_imputed_AEWithMAskOrigFeatUlzee_test_allFeatureData_0p1_p_Pub_v3.csv'
	mask_data_file = '/u/project/sriram/ulzee/imp/data/mdd/masks/mask_test_OBS099_0.csv'
	num_bootstraps = 100
	saveas = '/u/scratch/p/pterway/UCLAProjects/ulzeeAutocomplete/AutoComplete/datasets/transformerIncorrectWithMask/results_r2_v3.json'
#%%
